package com.example.ll.comllpeace_part.sleep_backgroud;
...
import com.example.ll.comllpeace_part.CenterImageSpan;
import com.example.ll.comllpeace_part.R;

public class SleepTotalActivity extends AppCompatActivity {
...
//        } );
        ...
        tabLayout.addTab( tabLayout.newTab().setCustomView( setCustomView( R.drawable.ic_launcher_background, "首页" ) ) );
        tabLayout.addTab( tabLayout.newTab().setCustomView( setCustomView( R.drawable.ic_launcher_background, "资讯" ) ) );
...
//        tabLayout.addTab(tabLayout.newTab().setText(setImageSpan("Tab4",R.drawable.ic_me)));
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View rootView = inflater.inflate( R.layout.sleep_fragment, container, false );
